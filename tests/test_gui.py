...
def _fake_report() -> DiagnosticReport:
    entries = [
        DiagnosticEntry(
            index=1, value=r"C:\Windows\System32", scope=Scope.SYSTEM,
            exists=True, is_dir=True, is_duplicate=False, duplicate_of=None,
            is_empty=False, has_unexpanded_vars=False,
            expanded_value=r"C:\Windows\System32",
        ),
        DiagnosticEntry(
            index=2, value=r"C:\Windows", scope=Scope.SYSTEM,
            exists=True, is_dir=True, is_duplicate=False, duplicate_of=None,
            is_empty=False, has_unexpanded_vars=False,
            expanded_value=r"C:\Windows",
        ),
        DiagnosticEntry(
            index=3, value=r"C:\missing", scope=Scope.USER,
            exists=False, is_dir=False, is_duplicate=False, duplicate_of=None,
            is_empty=False, has_unexpanded_vars=False,
    ...
    return DiagnosticReport(
        entries=entries,
        summary=DiagnosticSummary(total=3, valid=2, invalid=1, duplicates=0, empty=0, files=0),
        os_name="windows",
        path_length=60,
    )
...
def test_entry_display_duplicate():
    ...
    entry = DiagnosticEntry(
        ...
        exists=True, is_dir=True, is_duplicate=True, duplicate_of=2,
        is_empty=False, has_unexpanded_vars=False,
        expanded_value=r"C:\Windows",
    )
    tag, marker, notes = _entry_display(entry)
...
def test_entry_display_empty():
    ...
    entry = DiagnosticEntry(
        ...
        exists=False, is_dir=False, is_duplicate=False, duplicate_of=None,
        is_empty=True, has_unexpanded_vars=False,
        expanded_value="",
    )
    tag, marker, notes = _entry_display(entry)
    assert tag == "dim"
