...
def write_changed_snapshot(writer: PathWriter, current: PathSnapshot, updated: PathSnapshot, scope: Scope) -> None:
    if scope in {Scope.SYSTEM, Scope.ALL} and current.system_path != updated.system_path:
