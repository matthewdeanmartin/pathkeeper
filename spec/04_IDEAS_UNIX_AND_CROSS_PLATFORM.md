...
2. WSL PATH awareness — many Windows devs run in both contexts
3. Homebrew prefix validation — strong macOS developer identity
4. Conda environment detection — important safety check for a large audience
5. Effective PATH vs. persistent PATH reconciliation — the hardest but most
